...
export default {
  ...
  render3D: function (element, layer, scene) {
    ...
    let mtl = require('./Shipping Container 01.mtl');
    let obj = require('./Shipping Container 01.obj');
    let img = require('./Shipping Container 11_M04_Base Color.png');
